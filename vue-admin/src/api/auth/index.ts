  ...
  return request({
    ...
    headers: {
      ...
      Authorization: `Basic ${base64Str(
        `${import.meta.env.VITE_OAUTH_PASSWORD_CLIENT_ID}:${import.meta.env.VITE_OAUTH_PASSWORD_CLIENT_SECRET}`
      )}`, // 客户端信息Base64明文：mall-admin:123456
    },
  });
}
...
export function oauth2Login(data: any): AxiosPromise<LoginResult> {
  return request({
    baseURL: import.meta.env.VITE_OAUTH_BASE_API,
    url: "/login",
    method: "post",
    data: data,
    headers: {
