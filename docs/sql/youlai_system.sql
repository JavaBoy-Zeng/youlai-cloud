...
CREATE TABLE `sys_menu`  (
                             ...
                             `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
                             PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 106 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单管理' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_menu` VALUES (20, 0, 2, '多级菜单', '/multi-level', 'Layout', NULL, 'nested', 8, 1, '/nested/level1/level2', NULL, NULL, NULL, '2022-02-16 23:11:00', '2022-02-16 23:11:00');
...
INSERT INTO `sys_menu` VALUES (89, 0, 1, '首页', '/dashboard', 'dashboard/index', NULL, 'homepage', 0, 1, NULL, '0', NULL, 1, NOW(), NOW());
INSERT INTO `sys_menu` VALUES (90, 0, 2, '决策引擎', '/decision-engine', 'Layout', NULL, 'api', 6, 1, '/decision-engine/scenes', '0', 1, NULL, NOW(), NOW());
INSERT INTO `sys_menu` VALUES (91, 90, 1, '场景', 'scenes', 'decision-engine/console/index', NULL, 'document', 1, 1, NULL, '0,90', NULL, 1, NOW(), NOW());
INSERT INTO `sys_menu` VALUES (92, 90, 1, '变量', 'variables', 'decision-engine/console/index', NULL, 'dict_item', 2, 1, NULL, '0,90', NULL, 1, NOW(), NOW());
INSERT INTO `sys_menu` VALUES (93, 90, 1, '规则', 'rules', 'decision-engine/console/index', NULL, 'todolist', 3, 1, NULL, '0,90', NULL, 1, NOW(), NOW());
INSERT INTO `sys_menu` VALUES (94, 90, 1, '规则集', 'rule-sets', 'decision-engine/console/index', NULL, 'tree', 4, 1, NULL, '0,90', NULL, 1, NOW(), NOW());
INSERT INTO `sys_menu` VALUES (95, 90, 1, '决策流', 'flows', 'decision-engine/console/index', NULL, 'cascader', 5, 1, NULL, '0,90', NULL, 1, NOW(), NOW());
INSERT INTO `sys_menu` VALUES (96, 90, 1, '数据源', 'data-sources', 'decision-engine/console/index', NULL, 'redis', 6, 1, NULL, '0,90', NULL, 1, NOW(), NOW());
